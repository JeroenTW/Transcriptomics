...
Om te kijken welke genen er worden gebruit bij RA zijn de genen met R geanaliseerd. De materialen zijn afkomstig van uit de synofim van 4 patienten met RA en 4 patienten zonder RA. Het was bevestigd met de gene die auto antistoffen. Eerst werden de packages ingeladen. Nadat deze waren ingeladen is er een index gemaakt en de monsters ingeladen en gealined. De gemaakte bestanden werden daarna gesorteerd. Er werd daarna een DESeq data set aangemaakt en met daarna een controle. Daarna werd er een vulcano plot gemaakt. Daarna ENTREZ. en daarna pathview. en daarna ggplot.
